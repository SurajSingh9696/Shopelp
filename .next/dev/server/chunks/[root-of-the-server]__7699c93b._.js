...
"[project]/app/api/categories/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    ...
    const { error, value } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validatePayload"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["categorySchema"], body);
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error
    ...
    try {
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Category$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            _id: id,
            userId
        }, {
            name: value.name,
...
async function DELETE(request, { params }) {
    ...
    const { id } = await params;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
    const category = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Category$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
        _id: id,
        userId
    });
    if (!category) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7699c93b._.js.map