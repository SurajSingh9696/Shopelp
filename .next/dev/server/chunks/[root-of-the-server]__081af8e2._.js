...
async function POST(request) {
    ...
    if (refreshToken) {
        const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyRefreshToken"])(refreshToken);
        if (decoded?.sub) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(decoded.sub, {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["clearAuthCookies"])(response);
    return response;
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__081af8e2._.js.map