...
"[project]/app/api/items/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    ...
    if (oldPrice !== newPrice && newPrice > 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$SellingPriceHistory$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            userId,
            itemId: item._id,
            sellingPricePerSmallPacket: newPrice,
...
async function DELETE(request, { params }) {
    ...
    const { id } = await params;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
    const item = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Item$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
        _id: id,
        userId
    });
    if (!item) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbe21a0b._.js.map