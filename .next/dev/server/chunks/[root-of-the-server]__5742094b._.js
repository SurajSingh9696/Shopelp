...
"[project]/app/api/purchases/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const { error, value } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validatePayload"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["purchaseSchema"], body);
    if (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error
    ...
    if (hasLineItems) {
        ...
        const lineItems = value.lineItems.map((line)=>{
            ...
            const profitMarginPercent = sellingPricePerBox > 0 ? (profitPerBox / sellingPricePerBox * 100).toFixed(2) : 0;
            return {
                itemId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Types.ObjectId(line.itemId),
        ...
        const totalProfit = lineItems.reduce((sum, line)=>sum + (line.profitPerBox || 0) * (line.quantity || 0), 0);
        const purchase = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Purchase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        ...
        if (bulkOps.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Item$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bulkWrite(bulkOps);
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: purchase
    ...
    const item = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Item$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(value.itemId);
    if (!item) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: "Item not found"
    ...
    const purchase = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Purchase$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        userId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Types.ObjectId(userId),
        itemId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].Types.ObjectId(value.itemId),
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Item$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(value.itemId, {
        $inc: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5742094b._.js.map